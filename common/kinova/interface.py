...
class KinovaGen3RobotInterface(RobotInterfaceBase):
    ...
    def __init__(self,ip='192.168.1.10',username='admin',password='admin'):
        RobotInterfaceBase.__init__(self,name='Kinova Gen3 7DOF',klamptModelFile=os.path.join(os.path.dirname(__file__),"../../data/robots/kinova_with_robotiq_85.urdf"))
        self.ip = ip
...
def make():
    ...
    return KinovaGen3RobotInterface()