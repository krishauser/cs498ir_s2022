...
class SimulatedMirobotWithVacuumAndSensor:
    """The main API for interacting with the robot.

    You will want to learn how to use this.
    """
    ...
    def beginStep(self) -> None:
        if self.numIters == 0:
            ...
            print("Sensors:",self.arm.sensors())
...
def createRobotController() -> SimulatedMirobotWithVacuumAndSensor:
    """Creates the robot controller that you will use in simulation testing."""
    world = WorldModel()
